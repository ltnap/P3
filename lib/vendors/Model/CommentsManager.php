...
abstract class CommentsManager extends Manager
{
    ...
    /**
     * Méthode renvoyant le nombre total de commentaire.
     * @return int
     */
    abstract public function count();

    /**
     * Méthode permettant d'avoir la liste des commentaires signalés
     * @param
     * @return Comments
     */
    abstract public function getListReportComments();

    /**
     * Méthode renvoyant le nombre total de commentaire signalés
     * @param
     * @return int
     */
    abstract public function countReportComments();
